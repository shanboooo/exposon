...
![Roadmap](https://img.shields.io/badge/Roadmap-THM%20%2B%20Track%20Later-F9A825)
...
The **Exposon Track** iOS app will also be open-sourced in a later release.

本仓库目前开放 **Exposon Cam** 和 **Exposon Air** 的相关内容。  
**Exposon Thm** 将在后续开源。  
**Exposon Track** iOS 软件也将在后续开源。

---

## Project Overview | 项目简介

Exposon focuses on urban mobility research through mobile sensing devices.  
The current repository centers on two device lines:
...
Exposon 关注城市环境中的移动研究，通过移动传感设备采集街景、空气质量与轨迹相关数据。  
当前仓库主要包含两条设备线：
